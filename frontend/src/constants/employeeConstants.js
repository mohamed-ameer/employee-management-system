...
export const EMPLOYEE_WORKFLOW_UPDATE_REQUEST = 'EMPLOYEE_WORKFLOW_UPDATE_REQUEST'
export const EMPLOYEE_WORKFLOW_UPDATE_SUCCESS = 'EMPLOYEE_WORKFLOW_UPDATE_SUCCESS'
export const EMPLOYEE_WORKFLOW_UPDATE_FAIL = 'EMPLOYEE_WORKFLOW_UPDATE_FAIL'
export const EMPLOYEE_WORKFLOW_UPDATE_RESET = 'EMPLOYEE_WORKFLOW_UPDATE_RESET'
